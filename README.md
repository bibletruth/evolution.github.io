...
ПОЗИЦИЯ ЭВОЛЮЦИИ  | ПОЗИЦИЯ БИБЛИИ
------------- | -------------
Болезни появились задолго до существования человека, а без смерти нет развития | Болезни и смерть --- следствия грехопадения
В истории человечества не было момента, когда людей было бы всего 2  | Content Cell
Опыт большинства (либо авторитетных людей) не является критерием истинности | 



$ \ color {red} {слово} $

![<alt text>](<C:/Users/ASUS User/Downloads/Downloads/sincerely-media-BPb0tlUc_CQ-unsplash.jpg>)

Example:
![alt text for image](<C:/Users/ASUS User/Downloads/Downloads/sincerely-media-BPb0tlUc_CQ-unsplash.jpg>)
